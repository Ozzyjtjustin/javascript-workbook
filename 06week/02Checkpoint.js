...
// const sumEvens = (piObj) => {
//   const evenNums = []
//   evenNums.push(piObj.filter((num) => {
//     return num % 2 === 0
//   }))
// }
// sumEvens(piNums)
...
const atxIdx = (obj) => {
  var winner = Object.keys(obj).find((num, index)=>{
    return parseInt(num) + index === 512
  })
}
atxIdx(numCount)
